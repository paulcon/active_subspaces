...
design = maximin_design(Y, 3);

figure
scatter(Y(:,1),Y(:,2),'marker','o','markerfacecolor','b')
hold on
scatter(design(:,1),design(:,2),'marker','o','markerfacecolor','r')

%% Test gauss_hermite_design.m

design = gauss_hermite_design([3, 4, 2])
